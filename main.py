...
async def startup():
    # server.py, manual_player_ws.py, random_player.py を自動起動
    subprocess.Popen(["python", "samples/server.py"])
    subprocess.Popen(["python", "samples/manual_player_ws.py", "localhost", "8000"])
    subprocess.Popen(["python", "samples/random_player_ws.py", "localhost", "8000"])
'''
